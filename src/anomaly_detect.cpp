...
// include the C array generated by xxd
...
// Replace with threshold you computed
static float ANOMALY_THRESHOLD = 32.52702f;
...
void anomaly_init() {
    // load model buffer
    const tflite::Model* model = tflite::GetModel(ae_uint8_tflite);
